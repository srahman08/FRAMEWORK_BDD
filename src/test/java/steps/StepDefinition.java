...
public class StepDefinition {
	...
	public void user_enters_and_and_and_and_and(String AccountTitle, String InitialBalance, String accountNUmber, String phoneNumber, String accountDescription, String ContactPer) {
		addnew.accountTitleName(AccountTitle);
		addnew.initBalance(InitialBalance);
		addnew.accountNUmber(accountNUmber);
		addnew.phoneNumber(phoneNumber);
		addnew.accountDescription(accountDescription);
		addnew.contactPersonName(ContactPer);
}
